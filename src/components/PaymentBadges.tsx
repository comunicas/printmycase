...
const PaymentBadges = () => (
  <div className="flex flex-col items-center gap-4 py-6">
    ...
    <div className="flex items-center gap-2 text-muted-foreground">
      ...
      <img <img src="/lovable-uploads/stripe-logo.webp" alt="Stripe" className="h-5 w-auto opacity-50" width={60} height={20} /> alt="Stripe" className="h-5 w-auto opacity-50" width={60} height={20} />
      <div className="w-10 border-t border-muted-foreground/20" />
    </div>
  </div>
);
